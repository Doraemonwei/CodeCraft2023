...
al_dont_need_bench_id = [1, 2, 6, 8, 13, 14, 15, 17, 19, 24]
...
def map_2_instruct(is_carry, robot_loc, robot_angle, bench_loc, robot_id):
    ...
    # 防止把另一个更靠近0的工作台挤死
    if robot_loc[0] <= 3 and robot_loc[1] >= 47:
        m_2_bench41 = cal_distance(robot_loc[0], robot_loc[1], n_benches[0][2][0], n_benches[0][2][1])
